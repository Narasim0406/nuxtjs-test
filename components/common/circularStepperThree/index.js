...
export class CircularStepperThree extends React.Component {
  step1={}
  constructor(props) {
        super(props);
        this.state = {
          ...
          formData: this.props.data,
            type1:{
              ...
              placeholder2:"Describe the details"
            },
            type2:{
      ...
      <>  
                  ...
                  <div className="text-center ">
                    <div>
                      ...
                      />
                      {this.validator.message('Location', formData.location, 'required',{ className: 'text-danger' })}
                    </div>
                    <div>
                    <input className=" bg-transparent border-bottom form-stepper-choices"
                    ...
                    onChange={ this.handleChange } 
                    />
                    {this.validator.message('Description', formData.desDetails, 'required',{ className: 'text-danger' })}
...
export default CircularStepperThree